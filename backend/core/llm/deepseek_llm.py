...
Based on the DeepSeek API documentation from docs/providers/deepseek-api-reference.md
...
class DeepSeekLLM(BaseLLM):
    ...
    Supports deepseek-flash and deepseek-reasoner models.
    """
    ...
    async def function_calling(
        ...
        **kwargs
        ...
        Only deepseek-flash supports function calling.
        """
        if model == "deepseek-reasoner":
            logger.warning("Function calling is not supported by deepseek-reasoner. Using deepseek-flash instead.")
