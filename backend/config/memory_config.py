...
class MemoryConfig:
    ...
    def from_env(cls) -> "MemoryConfig":
        ...
        return cls(
            ...
            generation_model=os.getenv("MEMORY_GENERATION_MODEL") or os.getenv("DEEPSEEK_DEFAULT_MODEL") or os.getenv("DEEPSEEK_MODEL", "deepseek-flash"),
    ...
    def validate(self) -> tuple[bool, Optional[str]]:
        ...
        if self.cache_ttl < 1 or self.query_cache_ttl < 1 or self.batch_size < 1:
            return False, "Memory cache TTLs and batch size must be positive"
