...
class LLMConfig:
    ...
    def _get_ollama_config(self) -> ProviderConfig:
        ...
        return ProviderConfig(
            ...
            default_model=os.getenv("OLLAMA_DEFAULT_MODEL") or os.getenv("OLLAMA_MODEL", "gemma3:4b"),
    ...
    def _get_deepseek_config(self) -> ProviderConfig:
        ...
        return ProviderConfig(
            ...
            default_model=os.getenv("DEEPSEEK_DEFAULT_MODEL") or os.getenv("DEEPSEEK_MODEL", "deepseek-flash"),
    ...
    def _get_zhipu_config(self) -> ProviderConfig:
        ...
        return ProviderConfig(
            ...
            default_model=os.getenv("ZHIPU_DEFAULT_MODEL") or os.getenv("ZHIPU_MODEL", "glm-4.6"),
