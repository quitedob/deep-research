  ...
  template: `
    <div class="chat-animation">
      <div class="message user-message">
        <div class="message-bubble">你好，我想了解一下人工智能的发展趋势</div>
      </div>
      <div class="message ai-message">
        <div class="message-bubble ai">AI正在思考...</div>
      </div>
      <div class="message ai-message">
        <div class="message-bubble ai">人工智能正在快速发展，主要包括机器学习、深度学习、自然语言处理等领域...</div>
      </div>
    </div>
  `
})
  ...
  template: `
    <div class="research-animation">
      ...
      <div class="research-items">
        <div class="research-item">📚 分析文献...</div>
        <div class="research-item">📊 处理数据...</div>
        <div class="research-item">📝 生成报告...</div>
      </div>
      <div class="research-result">
        <div class="result-preview">研究报告生成完成</div>
      </div>
    </div>
  `
})
  ...
  template: `
    <div class="code-animation">
      <div class="code-editor">
        <div class="code-line">import pandas as pd</div>
        <div class="code-line">data = pd.read_csv('data.csv')</div>
        <div class="code-line cursor">data.head()</div>
      </div>
      <div class="code-output">
        <div class="output-line">执行中...</div>
        <div class="output-line">✓ 执行成功</div>
      </div>
    </div>
  `
})
  ...
  template: `
    <div class="document-animation">
      ...
      <div class="document-processing">
        <div class="process-step">解析文档...</div>
        <div class="process-step">提取内容...</div>
        <div class="process-step">分析完成</div>
      </div>
    </div>
  `
})
  ...
  template: `
    <div class="monitoring-animation">
      ...
      <div class="status-indicators">
        <div class="indicator green">● 正常</div>
        <div class="indicator green">● 健康</div>
      </div>
    </div>
  `
})
  ...
  template: `
    <div class="collaboration-animation">
      ...
      <div class="collaboration-items">
        <div class="item">📝 共享文档</div>
        <div class="item">💬 实时讨论</div>
      </div>
    </div>
  `
})
