...
import CodeSandbox from '@/views/CodeSandbox.vue'; // 引入代码沙盒页面
import Documents from '@/views/Documents.vue'; // 引入文档管理页面
...
router.beforeEach((to) => {
    ...
    if (to.path === '/') {
        ...
        if (token) {
            ...
            // 未登录用户显示酷炫主页（包含登录/注册按钮）
            console.log('[Router] 未登录用户，显示主页');
            return true;
        }
    }
