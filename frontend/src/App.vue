  ...
  <div class="app-root-wrapper">
    ...
    <main class="app-main">
      <div class="view-container">
        <router-view :current-theme="theme" @toggle-theme="toggleTheme" />
      </div>
    </main>
...
import { notificationManager } from '@/composables/useNotifications.js';
const toastRef = ref(null);
watch(toastRef, component => notificationManager.registerToast(component));
