<template>
  <teleport to="body">
    <div class="toast-container" aria-live="polite" aria-relevant="additions text" :class="positionClass">
      <transition-group name="toast" tag="div">
        <div
          v-for="toast in toasts"
          :key="toast.id"
          v-dialog="toast.confirmation ? () => removeToast(toast.id) : null"
          :aria-label="toast.confirmation ? toast.title : undefined"
          class="toast"
        ...
        >
          <div class="toast-content">
            ...
            <button
              ...
              class="toast-close" aria-label="关闭通知"
            >
              ×
            </button>
          </div>
