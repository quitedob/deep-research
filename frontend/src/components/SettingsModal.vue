<template>
  <div class="settings-modal-overlay" @click.self="closeModal">
    <div class="settings-modal-content" v-dialog="closeModal">
      <button class="close-button" aria-label="关闭设置" @click="closeModal">×</button>
      <div class="settings-layout">
        <aside class="settings-sidebar">
          ...
          <ul>
            <li
                ...
                @keydown.enter="currentSection = section.id" @keydown.space.prevent="currentSection = section.id" tabindex="0" role="button"
            >
              {{ section.name }}
            </li>
          </ul>
        ...
        <main class="settings-main-content">
          ...
          <DataManagementSettings v-if="currentSection === 'data'" />
          <PersonalizationSettings v-if="currentSection === 'personalization'" />
