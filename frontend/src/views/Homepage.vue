    ...
    <nav class="navbar">
      <div class="nav-container">
        ...
        <div class="nav-actions">
          <button @click="toggleTheme" class="theme-toggle" aria-label="切换明暗主题" :title="isDark ? '切换到亮色模式' : '切换到暗色模式'">
            {{ isDark ? '☀️' : '🌙' }}
          </button>
...
.homepage.dark-theme {
  background: linear-gradient(135deg, #0b1824 0%, #16213e 100%);
  color: #e0e0e0;
}
...
.gradient-overlay {
  ...
  width: 100%;
  height: 100%;
  background: linear-gradient(45deg, rgba(3, 105, 161, 0.1) 0%, rgba(15, 118, 110, 0.1) 100%);
  pointer-events: none;
}

.dark-theme .gradient-overlay {
  background: linear-gradient(45deg, rgba(11, 24, 36, 0.8) 0%, rgba(22, 33, 62, 0.8) 100%);
}
