    ...
    <div class="auth-card">
      ...
      <form @submit.prevent="doRegister" class="form" novalidate>
        <div class="input-group">
          ...
          />
          <p role="alert" v-if="usernameError && touched.username" class="error">{{ usernameError }}</p>
        </div>
        ...
        <div class="input-group">
          ...
          />
          <p role="alert" v-if="passwordError && touched.password" class="error">{{ passwordError }}</p>
        </div>
        ...
        <div class="input-group">
          ...
          />
          <p role="alert" v-if="phoneError && touched.phone" class="error">{{ phoneError }}</p>
        </div>
        ...
        <div class="input-group">
          ...
          />
          <p role="alert" v-if="emailError && touched.email" class="error">{{ emailError }}</p>
        </div>
...
import { validateUsername, validatePassword } from '@/utils/input.js';
import { register } from '@/api/user.js';

import { saveCredentials } from '@/api/client.js';
...
const doRegister = async () => {
  ...
  try {
    ...
    saveCredentials(data, rememberMe.value);
    ...
    notifications.error(e.message || '注册失败');
  } finally {
